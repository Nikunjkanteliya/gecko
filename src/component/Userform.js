...
const Userform = () => {
  ...
  return (
    <>
      <p className="font-Mulish font-[700] text-[47px] leading-[59px] tracking-[0.16px] text-[#232323] mt-[50px] max-w-[785px] text-center mx-auto">
        {" "}
        Contact us
      </p>
      <form
        class="max-w-[785px] mx-auto mt-[50px] mb-[100px]"
        id="form-view"
